...
export function BentoCard({ icon, title, desc, children, className = "" }) {
  return (
    ...
    >
      ...
      <h3 className="font-heading text-xl tracking-tight mb-2">{title}</h3>
...
export default function Home() {
  return (
    <div className="bg-black overflow-x-hidden ">
      <section className="isolate relative min-h-screen overflow-hidden px-4 pb-20 pt-28 sm:px-8 sm:pt-28">
        ...
        <section className="relative z-10 py-28 max-w-5xl mx-auto px-6">
              ...
              >
                <div className="mt-5 rounded-xl bg-[#141417] border border-white/10 p-5 flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-4xl leading-none bg-linear-to-br from-amber-300 to-amber-500 bg-clip-text text-transparent">
                      28
                    </p>
         ...
         {/* ROLES */}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {ROLES.map((role) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-2xl tracking-tight mb-4">
                    {role.title}
                  </h3>
          ...
          {/* CTA */}
          <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
            <div className="relative isolate border border-amber-400/20 rounded-3xl px-3 sm:px-16 py-20 bg-linear-to-br from-amber-400/5 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="font-heading relative text-4xl md:text-5xl leading-tight tracking-tight mb-4">
