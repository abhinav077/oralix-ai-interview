...
function CardTitle({
  ...
  return (
    <div
      ...
      className={cn(
        "font-heading text-xl leading-tight font-normal tracking-[-0.025em] group-data-[size=sm]/card:text-base",
        className
      )}
      {...props} />
  );
...
function CardFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-lg border-t border-border/80 bg-muted/45 p-(--card-spacing)",
        className
      )}
      {...props} />
  );
